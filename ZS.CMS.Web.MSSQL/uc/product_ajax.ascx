<%@ Control Language="C#" AutoEventWireup="true" CodeFile="product_ajax.ascx.cs" Inherits="uc_product_ajax" %>

<div class="uc-product uc-data-list">
...
<script>
    $(function () {
        $(".uc-load-more").click(function () {
            ...
            var _route = "product_detail";
            $.ajax({
                type: "post",
                cache: false,
                async: false,
                url: "/ashx/ajax_web.ashx?module=product",
