<%@ Control Language="C#" AutoEventWireup="true" CodeFile="article_ajax.ascx.cs" Inherits="uc_article_ajax" %>

<div class="uc-article uc-data-list">
    ...
    $(function () {
        $(".uc-load-more").click(function () {
            ...
            $.ajax({
                ...
                cache: false,
                async: false,
                url: "/ashx/ajax_web.ashx?module=article",
