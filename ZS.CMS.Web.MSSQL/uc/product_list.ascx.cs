...
public partial class uc_product_list : System.Web.UI.UserControl
{
    ...
    protected void FillRepeater()
    {
        ...
        rptProduct.DataSource = bll.GetList(this._categoryID, this._pageSize, this._curPage, " and isCheck=1 ", this._sortFiled, out this._totalCount);
        rptProduct.DataBind();
        //数据分页
        string pageUrl = znUtils.CombUrls("/product/", "list/{0}&{1}", this._categoryID.ToString(), "znPage");
