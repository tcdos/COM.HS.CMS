<%@ Page Language="C#" AutoEventWireup="true" CodeFile="content_edit.aspx.cs" Inherits="cms_link_content_edit" %>
...
<body class="zs-page">
    <form id="form_content" runat="server">
        <div class="zs-location">
            ...
            <i class="zs-arrow"></i>
            <span><a href="content.aspx">友情链接</a></span>
            <i class="zs-arrow"></i>
            <span>链接编辑</span>
        </div>
        ...
        <div class="zs-form-nav">
            <ul id="form-tab">
                <li><a href="javascript:void(0)" class="selected">链接信息</a></li>
            </ul>    
        </div>
        <div class="zs-form-content" id="form-tabs">
            <div class="form-tabs-item">
                <table width="100%" class="zs-form-tab">
                    <tr>
                    <td class="right" width="120">所属类型</td>
                    <td><div class="zs-dropdown-list"><asp:DropDownList ID="ddlCategoryID" AutoPostBack="true" OnSelectedIndexChanged="ddlCategoryID_SelectedIndexChanged" runat="server" datatype="*"><asp:ListItem Value="" Selected="True">请选择类别</asp:ListItem><asp:ListItem Value="1">文本链接</asp:ListItem><asp:ListItem Value="2">图片链接</asp:ListItem></asp:DropDownList></div></td>
                    </tr>
                    <tr>
                    ...
                    <td><asp:TextBox ID="tbLinkUrl" runat="server" CssClass="zs-input" datatype="*2-100"></asp:TextBox></td>
                    </tr>
                    <asp:Panel ID="pnlLogoUrl" runat="server" Visible="false">
                    <tr>
                    <td class="right">Logo地址</td>
                    <td><asp:TextBox ID="tbLogoUrl" runat="server" CssClass="zs-input"></asp:TextBox><div class="zs-uploadFrame"><iframe name="upload" frameborder="0"  frameborder="no" style="" src="../upload/upload.aspx?type=single&controlID=tbLogoUrl"></iframe></div><div class="zs-upload-msg" id="tbLogoUrl-msg"></div></td>
                    </tr>
                    </asp:Panel>
                    <tr>
                    <td class="right top">简介</td>
                    <td><asp:TextBox ID="tbLinkNote" runat="server" CssClass="zs-textarea" TextMode="MultiLine"></asp:TextBox></td>
                    </tr>
                    <tr>
