...
namespace ZS.BLL
{
    ...
    {
        private readonly ZS.DAL.znProduct dal = new ZS.DAL.znProduct();
        public znProduct()
        { }
        ...
        /// 获取数据列表
        /// </summary>
        public List<ZS.Model.znProduct> GetModelList(string strWhere)
        {
        ...
        /// 获取数据列表
        /// </summary>
        public List<ZS.Model.znProduct> DataTableToList(DataTable dt)
        {
            List<ZS.Model.znProduct> modelList = new List<ZS.Model.znProduct>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                ZS.Model.znProduct model;
