<%@ Page Language="C#" AutoEventWireup="true" CodeFile="category.aspx.cs" Inherits="cms_download_category" %>
    ...
    <form id="form_category" runat="server">
        ...
        <div class="zs-tool" id="floatTool">
            <div class="zs-tool-l">
                <ul class="zs-tool-btn">
                    ...
                    <li><a class="zs-btn-add" href="category_edit.aspx?action=<%=ZS.KIT.znEnum.Actions.Add%>">新增</a></li>
                    <li><asp:LinkButton ID="lbDel" runat="server" CssClass="zs-btn-del" OnClientClick="return checkPost('lbDel')" OnClick="lbDel_Click">删除</asp:LinkButton></li>
                </ul>
            </div>
        </div>
        ...
        <div class="zs-main">
            <asp:Repeater ID="rptList" runat="server" onitemdatabound="rptList_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center"><asp:CheckBox ID="cbID" CssClass="checkAll" runat="server" style="vertical-align:middle;" /><asp:TextBox ID="tbID" runat="server" Text='<%#Eval("ID") %>' Visible="False"></asp:TextBox><asp:TextBox ID="tbLayer" runat="server" Text='<%#Eval("Layer") %>' Visible="False"></asp:TextBox></td>
