...
public partial class cms_link_content : znManage
{
    ...
    protected void FillRepeater()
    {
        ...
        {
            this.ddlCategoryID.SelectedValue = this._categoryID.ToString();
        }
    ...
    {
        string reUrl = znUtils.CombUrl(this._pageUrl, "categoryID={0}&searchWord={1}&propetry={2}", ddlCategoryID.SelectedValue.ToString(), tbSearchWord.Text, this._property);
        Response.Redirect(reUrl);
    }
