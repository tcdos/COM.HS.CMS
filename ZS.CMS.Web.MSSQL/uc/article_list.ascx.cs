...
public partial class uc_article_list : UserControl
{
    ...
    protected void FillRepeater()
    {
        ...
        rptArticle.DataSource = bll.GetList(this._categoryID, this._pageSize, this._curPage, " and isCheck=1 ", this._sortFiled, out this._totalCount);
        rptArticle.DataBind();
        //数据分页
        string pageUrl = znUtils.CombUrls("/news/", "list/{0}&{1}", this._categoryID.ToString(), "znPage");
