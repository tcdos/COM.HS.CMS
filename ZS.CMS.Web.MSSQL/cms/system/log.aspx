<%@ Page Language="C#" AutoEventWireup="true" CodeFile="log.aspx.cs" Inherits="cms_system_log" %>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <table width="100%" class="zs-data-table">
                    <thead>
                        <tr>
                            <th width="5%">选择</th>
                            <th align="left" width="10%">帐号</th>
                            <th align="left">日志</th>
                            <th align="left" width="15%">登录时间</th>
                            <th align="left" width="15%">登录IP</th>
                        </tr>
                    </thead>
                    <tbody>
                </HeaderTemplate>
