...
public partial class cms_download_content_edit : znManage
{
    private string _labelName = "ZS.CMS.Content.Download.Manage";
    ...
    private bool DoEdit(int ID)
    {
        ...
        if (bll.Exists(ID, false))
        {
            ...
            model.FileUrl = tbFileUrl.Text.Trim();
            model.isTop = 0;
            model.isElite = 0;
    ...
    private bool DoAdd()
    {
        ...
        model.isTop = 0;
        model.isElite = 0;
        model.isCheck = rblIsCheck.SelectedIndex;
        if (cbIsTop.Checked == true)
        {
            model.isTop = 1;
        }
