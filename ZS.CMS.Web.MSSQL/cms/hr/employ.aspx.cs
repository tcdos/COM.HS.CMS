...
public partial class cms_hr_employ : znManage
{
    ...
    protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
        {
            ...
            hlEdit.NavigateUrl = znUtils.CombUrl("employ_edit.aspx", "action={0}&id={1}&categoryID={2}&searchWord={3}&propetry={4}&page={5}", znEnum.Actions.Edit.ToString(), id.ToString(), this._categoryID.ToString(), this._searchWord, this._property.ToString(), this._curPage.ToString());
        }
    }
    ...
    protected void lbAdd_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("employ_edit.aspx?action=" + znEnum.Actions.Add.ToString());
    }
