...
namespace ZS.DAL
{
    ...
    public partial class znArticle
    {
        ...
        public bool Exists(int ID, bool isCheck)
        {
            ...
            strSql.Append("select count(1) from znArticle");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 Title from znArticle");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int, 4)
            };
        ...
        {
            string strSql = "select top 1 ID from znArticle where isCheck=1  order by isTop desc,SortID desc,PostTime desc,ID desc";
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into znArticle(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update znArticle set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update znArticle set " + strValue);
            strSql.Append(" where id=" + id);
        ...
        public bool Delete(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from znArticle ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)
            };
        ...
        public ZS.Model.znArticle GetModel(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 ID,CategoryID,Title,Source,SortID,Hits,SmallPic,Summary,Content,LinkUrl,isUrl,isTop,isElite,isCheck,UserName,PostTime from znArticle ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
                    new SqlParameter("@ID", SqlDbType.Int,4)
            };
            ...
            ZS.Model.znArticle model = new ZS.Model.znArticle();
        ...
        /// 得到一个对象实体
        /// </summary>
        public ZS.Model.znArticle DataRowToModel(DataRow row)
        {
            ZS.Model.znArticle model = new ZS.Model.znArticle();
            if (row != null)
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,CategoryID,Title,Source,SortID,Hits,SmallPic,Summary,Content,LinkUrl,isUrl,isTop,isElite,isCheck,UserName,PostTime,CategoryTitle from znArticleView where ID>0 ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,CategoryID,Title,Source,SortID,Hits,SmallPic,Summary,Content,LinkUrl,isUrl,isTop,isElite,isCheck,UserName,PostTime,CategoryTitle from znArticleView where ID>0");
            if (categoryID > 0)
            {
        ...
        public DataSet GetPageList(int categoryID, int pageSize, int pageIndex, string strWhere, string sortFiled, out int recordCount)
        {
            ...
            baseSql.Append("select ID,CategoryID,Title,Source,SortID,Hits,SmallPic,Summary,Content,LinkUrl,isUrl,isTop,isElite,isCheck,UserName,PostTime,CategoryTitle from znArticleView where ID>0");
            if (categoryID > 0)
            {
