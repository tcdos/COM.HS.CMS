<%@ Page Language="C#" AutoEventWireup="true" CodeFile="content.aspx.cs" Inherits="cms_link_content" %>
            ...
            <div class="zs-right">
                <div class="zs-dropdown-list">
                    <asp:DropDownList ID="ddlCategoryID" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCategoryID_SelectedIndexChanged">
                        ...
                        <asp:ListItem Value="1">文本链接</asp:ListItem>
            ...
            <asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound" OnItemCommand="rptList_ItemCommand">
                ...
                <table width="100%" class="zs-data-table">
                    <thead>
                        <tr>
                            <th width="5%">选择</th>
                            <th align="left">名称</th>
                            <th align="left" width="15%">所属类型</th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%#Eval("Title")%></td>
                        <td><%# Convert.ToInt32(Eval("CategoryID")) == 1 ? "文本链接" : "图片链接" %></td>
                        <td><%# Eval("SortID")%></td>
                        <td>
