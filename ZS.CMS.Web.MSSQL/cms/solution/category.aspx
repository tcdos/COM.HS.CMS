<%@ Page Language="C#" AutoEventWireup="true" CodeFile="category.aspx.cs" Inherits="cms_solution_category" %>
...
<body class="zs-page">
    <form id="form_category" runat="server">
        <div class="zs-location">
          ...
          <i class="zs-arrow"></i>
          <span><a href="product.aspx">解决方案</a></span>
          <i class="zs-arrow"></i>
          <span>栏目类别</span>
        </div>
            ...
            <asp:Repeater ID="rptList" runat="server" onitemdatabound="rptList_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%#Convert.ToBoolean(Eval("isUrl"))==true ? "<span class='zs-red'>外链栏目</span>":"内部栏目"%></td>
                        <td><%#Eval("SortID")%></td>
