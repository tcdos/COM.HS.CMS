<%@ Page Language="C#" AutoEventWireup="true" CodeFile="content.aspx.cs" Inherits="cms_solution_content" %>
        ...
        <div class="zs-tool" id="floatTool">
            <div class="zs-left">
                <ul class="zs-tool-btn">
                    ...
                    <li><asp:LinkButton ID="lbTop" runat="server" CssClass="zs-btn-top" OnClick="lbTop_Click" OnClientClick="return checkPostBack('lbTop')">固顶</asp:LinkButton></li>
                    <li><asp:LinkButton ID="lbElite" runat="server" CssClass="zs-btn-elite" OnClick="lbElite_Click" OnClientClick="return checkPostBack('lbElite')">推荐</asp:LinkButton></li>
            ...
            <div class="zs-right">
                <div class="zs-dropdown-list"><asp:DropDownList ID="ddlCategory" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged"></asp:DropDownList></div>
                <div class="zs-dropdown-list">
                    <asp:DropDownList ID="ddlProperty" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlProperty_SelectedIndexChanged">
                        ...
                        <asp:ListItem Value="isElite">推荐</asp:ListItem>
                ...
                <table width="100%" class="zs-data-table">
                    <thead>
                        <tr>
                            <th width="5%">选择</th>
                            <th align="left">名称</th>
                            <th align="left" width="15%">所属类别</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="zs-quick-btn">
                                <asp:LinkButton ID="isTop" CommandName="btnTop" runat="server" CssClass='<%# Convert.ToInt32(Eval("isTop")) == 1 ? "zs-lb-top" : "zs-lb-uptop"%>' ToolTip='<%# Convert.ToInt32(Eval("isTop")) == 1 ? "取消固顶" : "设置固顶"%>'></asp:LinkButton>
                                <asp:LinkButton ID="isElite" CommandName="btnElite" runat="server" CssClass='<%# Convert.ToInt32(Eval("isElite")) == 1 ? "zs-lb-elite" : "zs-lb-unelite"%>' ToolTip='<%# Convert.ToInt32(Eval("isElite")) == 1 ? "取消推荐" : "设置推荐"%>'></asp:LinkButton>
