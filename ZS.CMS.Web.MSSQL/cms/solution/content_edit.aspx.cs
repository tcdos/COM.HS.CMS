...
public partial class cms_solution_content_edit : znManage
{
    private string _labelName = "ZS.CMS.Content.Solution.Manage";
    private int _channelID = 6;
    ...
    public void FillData(int ID)
    {
        ...
        if (model != null)
        {
            ...
            tbShortTitle.Text = model.ShortTitle;
    ...
    private bool DoEdit(int ID)
    {
        ...
        if (bll.Exists(ID, false))
        {
            ...
            model.ShortTitle = tbShortTitle.Text.Trim();
            ...
            model.IdxPic = tbIdxPic.Text.Trim();
