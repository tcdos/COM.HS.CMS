...
public partial class cms_page_content : znManage
{
    private string _labelName = "ZS.CMS.Content.Page.Manage";
    private int _channelID = 5;
    private string _pageUrl = "content.aspx";
    public int _categoryID;
    private int _pageSize = 15;
    private string _sortFiled = "CategoryID asc,ID asc";
    ...
    {
        string reUrl = znUtils.CombUrl(this._pageUrl, "categoryID={0}&searchWord={1}&propetry={2}", ddlCategory.SelectedValue.ToString(), tbSearchWord.Text, this._property);
        Response.Redirect(reUrl);
    }
