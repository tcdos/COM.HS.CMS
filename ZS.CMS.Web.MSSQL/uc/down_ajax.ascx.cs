...
public partial class uc_down_ajax : System.Web.UI.UserControl
{
    ...
    protected void FillRepeater()
    {
        ...
        rptDownload.DataSource = bll.GetPageList(this._categoryID, this._pageSize, this._curPage, " and isCheck=1 ", this._sortFiled, out this._totalCount);
